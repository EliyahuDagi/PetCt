...
**Project report — long version**

> This is the archived long report, written 2026-09-02 around the 64x64x64 chain.
> The current main scheme, the native-depth results and the latest run are in
> [PROJECT_REPORT.md](PROJECT_REPORT.md). Numbers here were measured on a coarser
> grid and are **not** comparable with the ones there; keep this file for the side
> experiments, the derivations and the glossary.
